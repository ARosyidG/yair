...
@section('Content')
    <main class="Editor mx-5 my-5">
            ...
            <li id="Editor" class="list-group-item p-1 px-3">
                <form action="/Surat" method="post" class="space-y-6">
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="block text-sm font-medium text-gray-700">Subjek:</label>
                        <input type="text" name="subjek" class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" id="exampleInputPassword1" placeholder="Subjek" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="block text-sm font-medium text-gray-700">No. Surat:</label>
                        <input type="text" name="nomorSurat" class="form-control mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" id="exampleInputPassword1" placeholder="Nomor Surat">
                    </div>
                    <div class="form-group mt-3">
                        <label for="isi" class="block text-sm font-medium text-gray-700">Isi Surat :</label>
                        <textarea id="textisi" name="textisi" style="height: 400px" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                        @error('isi')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1" class="block text-sm font-medium text-gray-700">Jumlah yang bertanda tangan:</label>
                        <input class="d-inline mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" type="number" name="jumlah" id="jumlah" placeholder="jumlah">
                    </div>
                    <div id="TTD">
                        
                    </div>
                    <button class="btn btn-success w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" type="submit">Submit</button>
                </form>
            </li>
        </ul>
        <style>
        ...
        <ul class="list-group list-group flex-column mb-auto mt-3">
            <li class="list-group-item bg-success text-white d-inline"> <div class="d-inline w-100"> <h1>Preview</h1> </div> <span><button onclick="Refresh()" class="btn btn-primary">Refresh</button></span></li>
