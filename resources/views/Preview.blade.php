            ...
            <div class="container Header pb-2" style="border-bottom: solid black 3px">
                <div class="row">
                    ...
                    <div class="col" style="text-align: center">
                        ...
                        <small>LingkokBaru, DesaSukadamai, Kec. Jerowaru Kab. Lombok Timur, NTB, Km 1,5Tangun-BatuNampar
                        </small>
            ...
            <div id="ttdSurat" class="d-flex flex-wrap" style="height: 200px">
                @foreach ($Surat->ttdtosurat as $ttd)
                    ...
                    <div class="col m-3" style="height:100%; flex:40%; text-align:center">
                        <div><span class="TempatttdAnggota">{{ $ttd->Tempat }}</span> , <span
                                class="TanggaltdAnggota">{{ $ttd->Tanggal }}</span></div>
                        <p class="SebagaittdAnggota">{{ $ttd->Sebagai }}</p>
                        @if ($ttd->Sign == 'Signed')
                            <img src="{{ asset( 'storage/' . $ttd->Anggota->TTD->Gambar) }}" alt="" style="width:150px">
                            <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=http://yair.test/Signed/{{ $ttd->id }}"
                                alt="">
                        @else
                            <img src="/TTD/noTTD.png" alt="" style="width:150px">
                        @endif
